...
public class AddGroupWindow extends JDialog{
	...
	public static AddGroupWindow getInstance(Client client, User self) {
		AddGroupWindow inst = new AddGroupWindow(client, self);
		inst.setLocationRelativeTo(null);
		inst.setVisible(true);
		return inst;
	}

	public AddGroupWindow(Client client, User self) {
		initGUI();
		initListener();
		this.self = self;
		this.client = client;
	...
	private void initListener() {
		...
		okButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				message.setType(Constants.ADD_GROUP);
